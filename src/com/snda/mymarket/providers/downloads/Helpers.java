...
public class Helpers {
	...
	public static String generateSaveFile(Context context, String url, String hint,
			long currentBytes, String contentDisposition, String contentLocation,
		...
		if (destination == Downloads.DESTINATION_FILE_URI) {
			return getPathForFileUri(url, hint, currentBytes, contentDisposition,
	...
	private static String getPathForFileUri(String url, String hint, long currentBytes, 
